...
public class circuitCharging : MonoBehaviour {
    ...
    public static readonly string[] wordBank = new string[]
       {
                ...
                "EAGER", "EAGLE", "EARED", "EARLY", "EARTH", "EASED", "EASEL", "EATEN", "ECLAT", "EDEMA", "EDGES", "EERIE", "EIGHT", "ELATE", "ELBOW", "ELDER", "ELECT", "ELIDE", "ELITE", "ELUDE", "ELVES", "EMOTE", "EMPTY", "ENACT", "ENDED", "ENEMA", "ENEMY", "ENJOY", "ENSUE", "ENTER", "ENTRY", "ENVOY", "EQUAL", "EQUIP", "ERASE", "ERECT", "ERROR", "ESSAY", "ETHIC", "ETHOS", "ETUDE", "EVADE", "EVENT", "EVERY", "EVICT", "EXACT", "EXALT", "EXAMS", "EXERT", "EXILE", "EXIST", "EXTRA", "EXUDE",
                ...
                "ICHOR", "ICILY", "ICING", "ICONS", "IDEAL", "IDEAS", "IDIOM", "IDIOT", "IDLED", "IDYLL", "IGLOO", "ILIAC", "ILIUM", "IMAGE", "IMAGO", "IMBUE", "IMPLY", "INANE", "INCUS", "INDEX", "INDIA", "INDIE", "INERT", "INFER", "INFRA", "INGOT", "INLAY", "INLET", "INNER", "INPUT", "INTRO", "IRISH", "IRONY", "ISSUE", "ITCHY", "ITEMS", "IVORY",
    ...
    void Start() { //Shit that you calculate, usually a majority if not all of the module
        ...
        possibleWords = wordBank; //copy the word bank into the possible words list
    ...
    {
        string[] possibleWordsThisHint = possibleWords;
